    ...
    SRT_LOOKUP_TABLE srt_table = {
        ...
        { AFFECTST,
          { { STMT_SYNONYM, { { STMT_SYNONYM, POSTAFFECTST }, { NUM_ENTITY, POSTAFFECTST }, { WILDCARD, PREAFFECTS_WILD } } },
            ...
            { WILDCARD, { { STMT_SYNONYM, POSTAFFECTS_WILD }, { NUM_ENTITY, POSTAFFECTS_WILD }, { WILDCARD, PREAFFECTS_WILD } } } } },
        { NEXTBIP,
          { { STMT_SYNONYM, { { STMT_SYNONYM, POSTNEXTBIP }, { NUM_ENTITY, POSTNEXTBIP }, { WILDCARD, PRENEXTBIP_WILD } } },
            { NUM_ENTITY, { { STMT_SYNONYM, PRENEXTBIP }, { NUM_ENTITY, PRENEXTBIP }, { WILDCARD, PRENEXTBIP_WILD } } },
            { WILDCARD, { { STMT_SYNONYM, POSTNEXTBIP_WILD }, { NUM_ENTITY, POSTNEXTBIP_WILD }, { WILDCARD, PRENEXTBIP_WILD } } } } },
        { NEXTBIPT,
          { { STMT_SYNONYM, { { STMT_SYNONYM, POSTNEXTBIPT }, { NUM_ENTITY, POSTNEXTBIPT }, { WILDCARD, PRENEXTBIP_WILD } } },
            { NUM_ENTITY, { { STMT_SYNONYM, PRENEXTBIPT }, { NUM_ENTITY, PRENEXTBIPT }, { WILDCARD, PRENEXTBIP_WILD } } },
            { WILDCARD, { { STMT_SYNONYM, POSTNEXTBIP_WILD }, { NUM_ENTITY, POSTNEXTBIP_WILD }, { WILDCARD, PRENEXTBIP_WILD } } } } },
        { AFFECTSBIP,
          { { STMT_SYNONYM, { { STMT_SYNONYM, POSTAFFECTSBIP }, { NUM_ENTITY, POSTAFFECTSBIP }, { WILDCARD, PREAFFECTSBIP_WILD } } },
            { NUM_ENTITY, { { STMT_SYNONYM, PREAFFECTSBIP }, { NUM_ENTITY, PREAFFECTSBIP }, { WILDCARD, PREAFFECTSBIP_WILD } } },
            { WILDCARD, { { STMT_SYNONYM, POSTAFFECTSBIP_WILD }, { NUM_ENTITY, POSTAFFECTSBIP_WILD }, { WILDCARD, PREAFFECTSBIP_WILD } } } } },
        { AFFECTSBIPT,
          { { STMT_SYNONYM, { { STMT_SYNONYM, POSTAFFECTSBIPT }, { NUM_ENTITY, POSTAFFECTSBIPT }, { WILDCARD, PREAFFECTSBIP_WILD } } },
            { NUM_ENTITY, { { STMT_SYNONYM, PREAFFECTSBIPT }, { NUM_ENTITY, PREAFFECTSBIPT }, { WILDCARD, PREAFFECTSBIP_WILD } } },
            { WILDCARD, { { STMT_SYNONYM, POSTAFFECTSBIP_WILD }, { NUM_ENTITY, POSTAFFECTSBIP_WILD }, { WILDCARD, PREAFFECTSBIP_WILD } } } } },
        { CALLS,
